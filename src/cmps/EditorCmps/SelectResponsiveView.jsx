...
export function SelectResponsiveView({handleChange}) {
    ...
    return (
        <div className="choose-responsive-view">
            <input type="radio" id="large" name="respView" value="large-view" onChange={handleChange} defaultChecked />
            <label htmlFor="large" title="Large"><DesktopWindowsIcon style={ {fontSize: 27} } /></label>
